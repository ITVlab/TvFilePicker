...
/**
 * <p>This class extends the {@link GuidedStepFragment} to provide a simple file browser that is
 * native to Android TV and a DPAD interface. In your activity, you should initialize the picker
 * by calling {@link #newInstance(Activity, AbstractFile, FilterInterface, SelectionCallback)}.
 * </p>
 *
 ...
 * </p>
 */
public class FilePickerFragment extends GuidedStepFragment {
     ...
     */
    public static FilePickerFragment newInstance(Activity attachedActivity, AbstractFile files,
            @NonNull FilterInterface filterInterface, @NonNull SelectionCallback callback) {
    ...
    public GuidanceStylist.Guidance onCreateGuidance(Bundle savedInstanceState) {
        return new GuidanceStylist.Guidance("File Browser", mFiles.getUri().toString(),
                mFilterInterface.getDescription(), mActivity.getApplication().getApplicationInfo()
    ...
    public boolean explore(AbstractFile files) {
        GuidedStepFragment.add(mActivity.getFragmentManager(), newInstance(mActivity, files,
